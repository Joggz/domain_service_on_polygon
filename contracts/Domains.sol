...
contract Domains is ERC721URIStorage {
 ...
 modifier onlyOwner(){
   ...
   constructor(string memory _tld) payable ERC721("Laoye_Jnr Name Service", "LJS") {
      ...
      bytes(
        string(
          abi.encodePacked(
            '{"name": "',
            _name,
            '", "description": "A domain on the Laoye_Jnr name service", "image": "data:image/svg+xml;base64,',
